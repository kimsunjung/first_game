...
현재 구조와 다른 부분이 있을 수 있으므로, 파일 경로와 씬 구조는 `source-code-reference.md`를 우선 기준으로 삼는다.
...
## 읽는 순서 추천
1. `source-code-reference.md`
2. `map-art-priority-plan.md`
3. `town-layout-sketch.md`
4. `art-direction-guide.md`
5. `asset-purchase-guide.md`
6. 필요 시 각 시스템 구현 문서
