"""field_3 저주 황야 적 스프라이트 시트 (4×2) → 8개 PNG."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_enemies_field3_cursed_wilds_2026_05_13.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Enemies" / "Field3"
NAMES = ["cursed_soldier","dark_wolf","shadow_bat","bone_hound",
         "fallen_knight","plague_ghoul","ruin_golem","cursed_banner_wraith"]
CANVAS, COLS, ROWS = 128, 4, 2

# 양옆 padding으로 셀 경계 누출 캐릭터 복구 (특히 col 0/3)
...
def main():
    ...
    print(f"sheet={sw}x{sh}, cell={cw}x{ch}, pad={LEFT_PAD}/{RIGHT_PAD}")
