"""mine_3 결정/타락 적 시트 (2x2) -> 4개 PNG. 체커보드(거의 흰색) 배경 제거. 출력은 Enemies/Mine."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_enemies_mine3_crystal_final_2026_05_15.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Enemies" / "Mine"

NAMES = ["crystal_archer", "crystal_warlock", "crystal_brute", "corrupted_miner"]
CANVAS, COLS, ROWS = 128, 2, 2
