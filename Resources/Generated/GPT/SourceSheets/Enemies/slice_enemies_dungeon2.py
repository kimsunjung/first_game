"""dungeon_2 카타콤 적 스프라이트 시트 (4×2) → 8개 PNG."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_enemies_dungeon2_catacomb_2026_05_13.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Enemies" / "Dungeon2"
NAMES = ["skeleton_warrior","skeleton_mage","skeleton_rogue","bone_archer",
         "ghoul_brute","bone_knight","crypt_wraith","skeleton_champion"]
