"""네임드/보스 시트 (4×2) → 8개 PNG."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_enemies_named_bosses_2026_05_13.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Enemies" / "NamedBosses"
NAMES = ["forest_alpha_wolf","orc_warlord","graveyard_wight","skeleton_king",
         "plague_brute","ancient_lich","mine_golem","crystal_guardian"]
