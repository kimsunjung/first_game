"""
dungeon_1 오크 적 스프라이트 시트 (4 columns × 2 rows) → 8개 PNG 슬라이싱.

- 원본 시트: source_enemies_dungeon1_orcs_2026_05_13.png
- 균등 4×2 셀 슬라이싱.
- 배경 제거: 흰 / 체크무늬(연·진 회색 격자) → 알파 0.
- connected component 분석으로 셀 안 가장 큰 본체만 보존 — 인접 셀 픽셀 누출 차단.
- 동일한 정사각 캔버스(128×128)에 중앙 정렬.
- 출력: ../../Enemies/Dungeon1/<name>.png (8개)

사용법:
    python3 slice_enemies_dungeon1.py
"""
...
SOURCE_SHEET = SCRIPT_DIR / "source_enemies_dungeon1_orcs_2026_05_13.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Enemies" / "Dungeon1"
