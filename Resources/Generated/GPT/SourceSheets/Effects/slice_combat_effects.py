"""전투 이펙트 시트 (4×2) → 8개 PNG (128×128, padding 50, blob 격리)."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_combat_effects_2026_05_13.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Effects" / "Combat"
NAMES = ["sword_slash_arc","heavy_impact_spark","fire_bolt_impact","healing_glow",
         "dash_trail","poison_puff","level_up_sparkle","item_pickup_glow"]
