"""서리/빙하 장비 시트 (4x2) -> 8개 PNG. 체커보드(거의 흰색) 배경 제거. 출력은 Icons/Equipment."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_equipment_icons_frost_glacier_2026_05_15.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Icons" / "Equipment"
NAMES = [
    "frost_armor", "frost_helm", "frost_gloves", "glacier_boots",
    "frost_belt", "frost_cloak", "frost_vest", "frost_robe",
]
