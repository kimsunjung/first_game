"""화산/보스 보상/고급 무기 시트 (4x2) -> 8개 PNG. 체커보드(거의 흰색) 배경 제거."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_weapon_icons_fire_boss_dark_2026_05_15.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Icons" / "Items"
NAMES = [
    "kraken_trident", "flame_sword", "phoenix_bow", "magma_hammer",
    "inferno_staff", "crystal_staff_v2", "dread_blade_v2", "void_scepter_v2",
]
