"""소모품 아이콘 시트 (4x2) -> 8개 PNG. 체커보드(거의 흰색) 배경 제거. 출력은 Icons/Items."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_consumable_icons_combat_utility_2026_05_15.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Icons" / "Items"
NAMES = [
    "attack_potion", "defense_potion", "crit_potion", "mega_health_potion",
    "mega_mana_potion", "revive_scroll", "antidote_plus", "holy_water",
]
