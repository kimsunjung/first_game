"""암흑/공허 장비 시트 (4x2) -> 8개 PNG. 체커보드(거의 흰색) 배경 제거. 출력은 Icons/Equipment."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_equipment_icons_dark_void_2026_05_15.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Icons" / "Equipment"
NAMES = [
    "dark_armor", "dark_helm", "dark_gloves", "dark_boots",
    "dark_belt", "dark_cloak", "dark_vest", "dark_robe",
]
