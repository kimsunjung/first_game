"""화염/불사조 장비 시트 (4x2) -> 8개 PNG. 체커보드(거의 흰색) 배경 제거. 출력은 Icons/Equipment."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_equipment_icons_flame_phoenix_2026_05_15.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Icons" / "Equipment"
NAMES = [
    "flame_armor", "flame_helm", "flame_gloves", "flame_boots",
    "flame_belt", "flame_cloak", "phoenix_vest", "ember_cloak",
]
