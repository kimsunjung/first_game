"""장비 아이콘 시트 (4×2) → 8개 PNG. 빈 배경 + blob isolation으로 단일 아이템만 유지."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_equipment_accessories_2026_05_13.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Icons" / "Equipment"
NAMES = ["steel_helm","ranger_hood","knight_boots","swift_boots",
         "warrior_bracelet","mystic_bracelet","ruby_ring","moonstone_necklace"]
