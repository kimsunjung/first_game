"""Expansion v1 궁수 스킬북 아이콘 시트 (2x2) -> 4개 PNG. 출력은 Icons/Items."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_skillbook_icons_expansion_v1_archer_2026_05_15.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Icons" / "Items"
NAMES = [
    "skillbook_piercing_shot", "skillbook_backstep_shot",
    "skillbook_rain_of_arrows", "skillbook_hunter_focus",
]
CANVAS, COLS, ROWS = 64, 2, 2
