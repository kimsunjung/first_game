"""Regional Expansion v1 소모품 아이콘 시트 (4x2) -> 8개 PNG. 출력은 Icons/Items."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_consumable_icons_regional_expansion_v1_2026_05_15.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Icons" / "Items"
NAMES = [
    "tidal_tonic", "warming_draught", "defrost_potion", "fire_resist_elixir",
    "magma_brew", "battle_elixir", "curse_water", "mana_herb_extract",
]
