"""Regional Expansion v1 재료 아이콘 시트 (4x2) -> 8개 PNG. 출력은 Icons/Items."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_material_icons_regional_expansion_v1_2026_05_15.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Icons" / "Items"
NAMES = [
    "sea_kelp", "glacier_shard", "lava_stone", "titan_scale",
    "titan_core", "drake_scale", "drake_eye", "kraken_ink",
]
