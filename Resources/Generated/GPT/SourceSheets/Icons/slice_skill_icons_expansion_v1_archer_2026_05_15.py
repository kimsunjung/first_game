"""Expansion v1 궁수 스킬 아이콘 시트 (2x2) -> 4개 PNG. 출력은 Icons/Skills."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_skill_icons_expansion_v1_archer_2026_05_15.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Icons" / "Skills"
NAMES = [
    "piercing_shot", "backstep_shot",
    "rain_of_arrows", "hunter_focus",
]
