"""Expansion v1 전사/마법사 스킬 아이콘 시트 (4x2) -> 8개 PNG. 출력은 Icons/Skills."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_skill_icons_expansion_v1_combat_magic_2026_05_15.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Icons" / "Skills"
NAMES = [
    "cleave", "ground_slam", "battle_cry", "execute",
    "flame_wave", "frost_nova", "arcane_missile", "mana_shield",
]
