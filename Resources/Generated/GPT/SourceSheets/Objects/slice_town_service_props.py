"""마을 서비스 소품 시트 (4×2) → 8개 PNG (128×128, padding 50, blob 격리)."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_town_service_props_2026_05_13.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Objects" / "Town"
NAMES = [
    "shop_sign", "blacksmith_forge",
    "anvil_workstation", "weapon_rack",
    "potion_shelf", "magic_book_stand",
    "storage_crates_stack", "healer_shrine",
]
