"""월드 오브젝트 시트 (4×2) → 8개 PNG. padding 50 + blob 격리, 128×128 캔버스."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_world_interactables_2026_05_13.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Objects" / "World"
NAMES = ["save_crystal_shrine","magic_portal","dungeon_entrance_gate","quest_notice_board",
         "treasure_chest_closed","treasure_chest_open","mining_ore_vein","breakable_wooden_crate"]
