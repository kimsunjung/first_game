"""드랍/전리품/보상 시트 (4×2) → 8개 PNG (96×96, padding 50, blob 격리)."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_loot_reward_objects_2026_05_13.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Objects" / "Loot"
NAMES = [
    "small_gold_pile", "large_gold_pile",
    "loot_pouch", "rare_loot_glow",
    "epic_loot_glow", "boss_reward_chest",
    "broken_monster_trophy", "sparkling_item_drop",
]
