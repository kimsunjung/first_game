"""마을/필드 장식 오브젝트 시트 (4×2) → 8개 PNG (128×128, padding 50, blob 격리)."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_village_decorations_2026_05_14.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Objects" / "Village"
NAMES = [
    "wooden_fence_segment", "flower_planter",
    "water_well", "hay_bale_stack",
    "barrel_group", "campfire_ring",
    "street_lantern", "market_cloth_stall",
]
