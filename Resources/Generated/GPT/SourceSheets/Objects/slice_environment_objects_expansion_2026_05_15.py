"""확장 지역 환경 오브젝트 시트 (4x2) -> 8개 PNG. 체커보드(거의 흰색) 배경 제거. 출력은 Objects/{Coast,Snowfield,Volcano,Dungeon}."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_environment_objects_expansion_2026_05_15.png"
OBJECTS_ROOT = SCRIPT_DIR.parents[1] / "Objects"

# (subdir, name) in 4x2 reading order
ITEMS = [
    ("Coast", "broken_ship"),
    ("Coast", "lighthouse"),
    ("Coast", "coral_outcrop"),
    ("Snowfield", "snow_drift"),
    ("Snowfield", "ice_pillar"),
    ("Volcano", "lava_pool"),
    ("Volcano", "ember_rock"),
    ("Dungeon", "dungeon_entrance"),
]
CANVAS, COLS, ROWS = 128, 4, 2  # 환경 오브젝트는 아이콘보다 크게 (장식 오브젝트 표준)
