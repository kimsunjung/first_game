"""투사체 시트 (4×2) → 8개 PNG (96×96, padding 50, blob 격리)."""
from collections import deque
from pathlib import Path
from PIL import Image

SCRIPT_DIR = Path(__file__).resolve().parent
SOURCE_SHEET = SCRIPT_DIR / "source_projectiles_2026_05_13.png"
OUT_DIR = SCRIPT_DIR.parents[1] / "Projectiles"
NAMES = [
    "fire_bolt_projectile", "ice_shard_projectile",
    "arcane_bolt_projectile", "poison_glob_projectile",
    "bone_arrow_projectile", "dark_orb_projectile",
    "stone_shard_projectile", "holy_spark_projectile",
]
CANVAS, COLS, ROWS = 96, 4, 2
