...
- Hub loop v1 (2026-05-18, see `PLAN_DOC/hub-preparation-loop-v1.md`):
  ...
  - **Deferred TODO**: Hunting Contracts (separate `HuntingContractManager`, do NOT extend main `QuestManager`; SaveData v13) and hunting-ground decoration/mining/loot-glow polish — design fixed in the v1 doc, not yet implemented.
